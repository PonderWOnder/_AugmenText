...
class spell_mistake():
    ...
    def space_inserter (self, p=0.01):
        ...
        p : float, optional 
            The probability of inserting a random space between two letters. The default is 0.01.
    ...
    def calculate_distance(x1,y1,x2,y2):
        ...
        -------
        float
            eucledian distance between point x and y
    ...
    def calculating_probs(key):
        ...
        -------
        probs : dictionary
            keys are the letters, values are the assigned probabilities from either
            the upper or lower keyboard, depending on the original letter.
    ...
    def pick_random_letter(prob_dist):
        ...
        Parameters
        ----------
        prob_dist : dictionary
            the return from calculating_probs, keys are letters, values are probabilities
    
        Returns
        -------
        string
            a random letter according to the probabilty dictionary, picked through
            random.choices
    ...
    def realistic_spell_mistake_with_probs(self, p = 0.01):
        ...
        ----------
        token_list : list of strings
            tokenized text, each token is a single word
        p : float, optional
            Probability of altering a single letter. The default is 0.01.
    
        Returns
        -------
        final_list : list of strings
            list of altered strings/tokens
